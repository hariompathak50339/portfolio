      ...
      <div className="mx-auto max-w-7xl px-5 pt-16 pb-8 sm:px-8">
        <div className="flex flex-col justify-between gap-10 md:flex-row">
          <div>
            ...
            <p className="mt-4 max-w-xs text-sm leading-relaxed text-[#737681]">
          ...
          <nav className="flex gap-14">
            <div>
              <p className="font-mono text-[11px] tracking-[0.25em] text-[#737681] uppercase">
                Sitemap
              </p>
              <ul className="mt-4 space-y-2.5">
                {navLinks.map((l) => (
                  <li key={l.href}>
                    <a href={l.href} className="text-sm text-[#A7A9B2] transition-colors hover:text-[#7C6CFF]">
                      {l.label}
                    </a>
                  </li>
                ))}
                ...
                {socials.map((s) => (
                  <li key={s.label}>
                    <a
                      ...
                      target="_blank"
                      rel="noreferrer"
                      className="text-sm text-[#A7A9B2] transition-colors hover:text-[#7C6CFF]"
                    >
                      {s.label}
                    </a>
                  </li>
          ...
          <button
            ...
            className="flex h-12 w-12 items-center justify-center self-start rounded-full border border-white/15 text-[#F5F5F7] transition-colors hover:bg-[#F5F5F7] hover:text-[#0A0A0C] md:self-center"
